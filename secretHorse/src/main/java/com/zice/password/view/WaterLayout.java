//package com.zice.password.view;
//
...
//	}
//
//	public WaterLayout(Context context, AttributeSet attrs, int defStyle) {
...
//				R.styleable.WaterLayout);
//		mCirclelColor = typedArray.getColor(R.styleable.WaterLayout_color,
//				Color.LTGRAY);
//		mDuration = typedArray.getInteger(R.styleable.WaterLayout_duration,
//				DEFAULT_DURATION);
//		mFrameRate = typedArray.getInteger(R.styleable.WaterLayout_framerate,
//				DEFAULT_FRAME_RATE);
//		mColorAlpha = typedArray.getInteger(R.styleable.WaterLayout_alpha,
//				DEFAULT_ALPHA);
//		mCircleScale = typedArray.getFloat(R.styleable.WaterLayout_scale,
//				DEFAULT_SCALE);
//		typedArray.recycle();
//	}
//
